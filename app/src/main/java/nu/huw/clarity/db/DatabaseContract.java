...
public class DatabaseContract {
  ...
  public static abstract class Entries extends Base {
    ...
    public static final String COLUMN_ACTIVE = "active"; // Local activity setting, independent of activeEffective
    public static final String COLUMN_ACTIVE_EFFECTIVE = "activeEffective"; // Is it active/inactive because a parent is active?
    ...
    public static final String COLUMN_COUNT_REMAINING = "countRemaining";
    public static final String COLUMN_HAS_CHILDREN = "hasChildren";
    public static final String COLUMN_NAME = "name";
    public static final String COLUMN_PARENT_ID = "parentID";
    public static final String COLUMN_RANK = "rank"; // Used for ordering, finnicky format
    public static final String[] columns = {COLUMN_ID, COLUMN_DATE_ADDED, COLUMN_DATE_MODIFIED,
        COLUMN_ACTIVE, COLUMN_ACTIVE_EFFECTIVE, COLUMN_COUNT_AVAILABLE, COLUMN_COUNT_CHILDREN,
        COLUMN_COUNT_COMPLETED, COLUMN_COUNT_DUE_SOON, COLUMN_COUNT_OVERDUE, COLUMN_COUNT_REMAINING,
  ...
  public static abstract class Contexts extends Entries {
    ...
    public static final String[] columns = {COLUMN_ID, COLUMN_DATE_ADDED, COLUMN_DATE_MODIFIED,
        ...
        COLUMN_LATITUDE, COLUMN_LOCATION_NAME, COLUMN_LONGITUDE, COLUMN_ON_HOLD, COLUMN_RADIUS};
    public static final String CREATE = String.format(
        "CREATE TABLE Contexts(%s PRIMARY KEY,%s,%s,%s BOOLEAN DEFAULT 1,%s BOOLEAN DEFAULT 1,%s INT DEFAULT 0,%s INT DEFAULT 0,%s INT DEFAULT 0,%s INT DEFAULT 0,%s INT DEFAULT 0,%s INT DEFAULT 0,%s BOOLEAN DEFAULT 0,%s,%s,%s INT DEFAULT 0,%s,%s,%s,%s,%s BOOLEAN DEFAULT 0,%s)",
        COLUMN_ID, COLUMN_DATE_ADDED, COLUMN_DATE_MODIFIED, COLUMN_ACTIVE, COLUMN_ACTIVE_EFFECTIVE,
        COLUMN_COUNT_AVAILABLE, COLUMN_COUNT_CHILDREN, COLUMN_COUNT_COMPLETED,
        COLUMN_COUNT_DUE_SOON, COLUMN_COUNT_OVERDUE, COLUMN_COUNT_REMAINING, COLUMN_HAS_CHILDREN,
        COLUMN_NAME, COLUMN_PARENT_ID, COLUMN_RANK, COLUMN_ALTITUDE, COLUMN_LATITUDE,
  ...
  public static abstract class Folders extends Entries {
    ...
    public static final String[] columns = {COLUMN_ID, COLUMN_DATE_ADDED, COLUMN_DATE_MODIFIED,
        ...
        COLUMN_HAS_CHILDREN, COLUMN_NAME, COLUMN_PARENT_ID, COLUMN_RANK};
    public static final String CREATE = String.format(
        "CREATE TABLE Folders(%s PRIMARY KEY,%s,%s,%s BOOLEAN DEFAULT 1,%s BOOLEAN DEFAULT 1,%s INT DEFAULT 0,%s INT DEFAULT 0,%s INT DEFAULT 0,%s INT DEFAULT 0,%s INT DEFAULT 0,%s INT DEFAULT 0,%s BOOLEAN DEFAULT 0,%s,%s,%s INT DEFAULT 0)",
        COLUMN_ID, COLUMN_DATE_ADDED, COLUMN_DATE_MODIFIED, COLUMN_ACTIVE, COLUMN_ACTIVE_EFFECTIVE,
        COLUMN_COUNT_AVAILABLE, COLUMN_COUNT_CHILDREN, COLUMN_COUNT_COMPLETED,
        COLUMN_COUNT_DUE_SOON, COLUMN_COUNT_OVERDUE, COLUMN_COUNT_REMAINING, COLUMN_HAS_CHILDREN,
  ...
  public static abstract class Tasks extends Entries {
    ...
    public static final String COLUMN_BLOCKED_BY_DEFER = "blockedByDefer"; // Will always set 'blocked' to true
    ...
    public static final String[] columns = {COLUMN_ID, COLUMN_DATE_ADDED, COLUMN_DATE_MODIFIED,
        COLUMN_COUNT_AVAILABLE, COLUMN_COUNT_CHILDREN, COLUMN_COUNT_COMPLETED,
        COLUMN_COUNT_DUE_SOON, COLUMN_COUNT_OVERDUE, COLUMN_COUNT_REMAINING, COLUMN_HAS_CHILDREN,
        COLUMN_NAME, COLUMN_PARENT_ID, COLUMN_RANK, COLUMN_BLOCKED, COLUMN_BLOCKED_BY_DEFER,
    ...
    public static final String CREATE = String.format(
        "CREATE TABLE Tasks(%s PRIMARY KEY,%s,%s,%s INT DEFAULT 0,%s INT DEFAULT 0,%s INT DEFAULT 0,%s INT DEFAULT 0,%s INT DEFAULT 0,%s INT DEFAULT 0,%s BOOLEAN DEFAULT 0,%s,%s,%s INT DEFAULT 0,%s BOOLEAN DEFAULT 0,%s BOOLEAN DEFAULT 0,%s BOOLEAN DEFAULT 0,%s,%s,%s,%s,%s,%s,%s BOOLEAN DEFAULT 0,%s BOOLEAN DEFAULT 0,%s,%s BOOLEAN DEFAULT 0,%s BOOLEAN DEFAULT 0,%s BOOLEAN DEFAULT 0,%s,%s,%s,%s BOOLEAN DEFAULT 0,%s BOOLEAN DEFAULT 0,%s,%s,%s,%s,%s TEXT DEFAULT active,%s,%s,%s TEXT DEFAULT sequential)",
        ...
        COLUMN_COUNT_REMAINING, COLUMN_HAS_CHILDREN, COLUMN_NAME, COLUMN_PARENT_ID, COLUMN_RANK,
        COLUMN_BLOCKED, COLUMN_BLOCKED_BY_DEFER, COLUMN_COMPLETE_WITH_CHILDREN, COLUMN_CONTEXT,
