...
/**
 * An override of the AsyncLoader to utilise my DatabaseHelper, which then loads and returns a
...
public class DatabaseCursorLoader extends AsyncTaskLoader<Cursor> {
    ...
    /**
     * It needs these two methods because the original code is a little unintuitive and doesn't call
     * the right stuff...
     */
