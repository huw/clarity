...
public class OmniSyncDecrypter {
  ...
  /**
   * OmniSyncDecrypter takes in Omni Sync metadata and a passphrase, and can then be used to decrypt
   * any Omni Sync file a user encounters. Probably has a lot of errors and is definitely not
   * cryptographically secure. Modelled off <a href="https://github.com/omnigroup/OmniGroup/blob/master/Frameworks/OmniFileStore/DecryptionExample.py">DecryptionExample.py</a>
   *
