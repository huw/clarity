...
public class DatabaseContract {
  ...
  public static abstract class Contexts extends Entries {
    ...
    public static final String CREATE = String.format(
        "CREATE TABLE Contexts(%s PRIMARY KEY,%s,%s,%s INT DEFAULT 0,%s INT DEFAULT 0,%s INT DEFAULT 0,%s INT DEFAULT 0,%s INT DEFAULT 0,%s,%s,%s INT DEFAULT 0,%s,%s BOOLEAN DEFAULT 0,%s BOOLEAN DEFAULT 0,%s,%s,%s,%s BOOLEAN DEFAULT 0,%s)",
  ...
  public static abstract class Perspectives extends Base {
    ...
    public static final String CREATE = String.format(
        "CREATE TABLE Perspectives(%s PRIMARY KEY,%s,%s,%s DEFAULT any,%s DEFAULT any,%s DEFAULT any,%s,%s,%s,%s DEFAULT none,%s,%s)",
  ...
  public static abstract class Tasks extends Entries {
    ...
    public static final String COLUMN_PROJECT_STATUS = "projectStatus"; // active, inactive, dropped, or done
